    ...
    <section className="py-24 bg-slate-900/40 border-y border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-10 left-[calc(33.33%+1rem)] right-[calc(33.33%+1rem)] h-px bg-gradient-to-r from-indigo-600/40 via-violet-600/40 to-indigo-600/40" />
            ...
            return (
              <div key={step.step} className="relative flex flex-col items-center text-center p-8 rounded-2xl bg-slate-900 border border-slate-800">
                ...
                <div className="relative mb-5">
                  <div className="w-20 h-20 rounded-full bg-indigo-950/60 border border-indigo-800/60 flex items-center justify-center">
