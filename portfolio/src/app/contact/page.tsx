          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <RevealOnScroll preset="fade-left" className="lg:col-span-2">
              <div className="space-y-8">
                {/* Response Time Badge */}
                <div className="inline-flex items-center gap-2 bg-steel-500/10 border border-steel-500/20 rounded-full px-4 py-2">
                  <span className="w-2 h-2 bg-steel-500 rounded-full animate-pulse" />
